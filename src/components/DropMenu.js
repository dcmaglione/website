...
const DropMenu = () => {
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
        <Menu.Items className="origin-top-right absolute right-0 mt-4 w-max shadow-md border-2 border-primaryBgDark dark:border-primaryBgLight bg-secondaryBgDark dark:bg-secondaryBgLight text-2xl font-mono font-semibold">
          <div className="p-1/4">
            <Menu.Item>
              {({ active }) => (
                <a
